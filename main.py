...
regional_mod = Dataset("Data/netcdf/CANVAS_15-60s_400km.nc", Dataset.REGIONAL, "Data/spline.par", 'm')
# print(regional_mod.getDataset())
# pdb.set_trace()
global_mod = Dataset("Data/netcdf/glad-m25-vs-0.0-n4.nc", Dataset.GLOBAL, depthUnits='km')
# global_mod = Dataset("Data/netcdf/semucb-2014-ucb-vs.nc", Dataset.GLOBAL, depthUnits='km')
