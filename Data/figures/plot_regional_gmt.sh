...
input_file='../ascii/global_0050.xyz'
depth=50
output_file='./global_50.ps'
...
gmt grdimage -R$range_regional -J$frame_plot outgrid.grd -Bp5WSen:."depth ${depth} km": -C$dir_home"tomo.cpt" -Y5c -X3c -K > $output_file
gmt pscoast -R$range_regional -J -Dl -W0.03c,black -A5000 -O -K >> $output_file
gmt psxy -R$range_regional -J "./mask.xyz" -W0.03c,purple,-. -O -K >> $output_file
